...
8. 最近更新(主页)
9. 系统推荐(主页)
10. 玩家评论（结合推荐功能，或定向推送）(主页)
11. 用户评论页显示其他评论内容（显示XXX的其他评论）
12. 登陆后页面跳转（回原页面）
13. 评分后自动标记为玩过

【discard】
1. 热门标签（按照一二级标签处理，一级平台，二级类别）(主页)【discard】
2. 我关注的游戏动态（两类：我关注的人的最新动态；我关注的游戏的最新动态）(主页)【discard】
3. 猜你喜欢的游戏(主页)【discard】
    
【todo】
1. 游戏单
2. 游戏内容举报及举报管理策略（需要配合后台）
3. 移除已标记游戏。
4. 游戏信息中加入搜索链接（比如类型）
5. 相关链接。(下载 、 视频 、 新闻)
6. 客户端。	
